import numpy
from jvpm.jvpm_structures import ConstantPool, JvmStack
...
class ConstantPoolParser:
    ...
    def __init__(self, data):
        ...
        # we start at self.offset 10 since there are 10 bytes before the start of the
        # constant pool.
        self.offset = 10
...
tag"""
        ...
        if tag == 1:
            ...
            # don't forget to increment self.offset.
